!function (e, t) {
    ...
    function F(e, t, n) {
        var i = e.clipboardData || e.originalEvent && e.originalEvent.clipboardData, o = void 0,
            A = void 0;
    ...
    d.prototype = {
        ...
        constructor: u, _command: function (e) {
            ...
            var t = this.editor, n = this.$elem, i = /^h/i,
    ...
    f.prototype = {
        ...
        constructor: m, onClick: function (e) {
            ...
            var n = this, i = c("input-link"), A = c("input-text"), r = c("btn-ok"),
                a = c("btn-del"), s = this._active ? "inline-block" : "none", l = new f(this, {
                    width: 300,
                    tabs: [{
                        title: "链接",
        ...
        constructor: I, onClick: function (e) {
            ...
            var t = this.editor, n = this.$elem, i = /^BLOCKQUOTE$/i,
                o = t.cmd.queryCommandValue("formatBlock");
            i.test(o) ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"))
        }
    }, Q.prototype = {
        constructor: Q, onClick: function (e) {
            var t = this.editor, n = t.selection.getSelectionStartElem(),
                i = t.selection.getSelectionEndElem(), A = t.selection.isSelectionEmpty(),
                r = t.selection.getSelectionText(), c = void 0;
        ...
        constructor: S, onClick: function () {
            ...
            var e = this, t = c("add-row"), n = c("add-col"), i = c("del-row"), o = c("del-col"),
                A = c("del-table");
            new f(this, {
                width: 320, tabs: [{
                    title: "编辑表格",
            ...
            if (e) {
                var t = e.tr, n = o(t.elem), i = e.td, A = i.length,
                    r = document.createElement("tr"), c = "", a = void 0;
        ...
        constructor: D, onClick: function () {
            ...
            var e = this.editor, t = c("width-30"), n = c("width-50"), i = c("width-100"),
                o = c("del-btn"), A = [{
                    title: "编辑图片",
            ...
            var e = this.editor, t = e.uploadImg, n = e.config, i = c("up-trigger"),
                A = c("up-file"), r = c("link-url"), a = c("link-btn"), s = [{
                    title: "上传图片",
    ...
    q.bold = l, q.head = u, q.fontSize = h, q.fontName = p, q.link = m, q.italic = g, q.redo = w, q.strikeThrough = v, q.underline = E, q.undo = b, q.list = B, q.justify = y, q.foreColor = C, q.backColor = x, q.quote = I, q.code = Q, q.emoticon = M, q.table = S, q.video = k, q.image = D, _.prototype = {
        ...
        constructor: U, init: function () {
            ...
            var n = this.editor, i = n.config, o = i.pasteFilterStyle, A = i.pasteTextHandle,
                r = i.pasteIgnoreImg, c = n.$textElem, a = 0;
        ...
        constructor: L, _alert: function (e, t) {
            ...
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgServer, c = i.uploadImgShowBase64,
                    ...
                    d = i.uploadFileName || "", u = i.uploadImgParams || {},
                    h = i.uploadImgParamsWithUrl, p = i.uploadImgHeaders || {},
                    f = i.uploadImgHooks || {}, m = i.uploadImgTimeout || 3e3,
                    g = i.withCredentials;
                null == g && (g = !1);
    ...
    j.prototype = {
        constructor: j, _initConfig: function () {
            ...
            var e = this, t = this.toolbarSelector, n = o(t), i = this.textSelector,
                A = this.config, r = A.zIndex, a = void 0, s = void 0, l = void 0, d = void 0;
            ...
            s.on("compositionstart", function () {
                ...
                var n = l.isContain(o(t.target)), i = a.isContain(o(t.target)),
                    A = a[0] == t.target;
